...
def create_tables() -> list:
    ...
    "CREATE TABLE identities(identity_id INT NOT NULL AUTO_INCREMENT PRIMARY KEY, name VARCHAR(255) NOT NULL, user_id BIGINT NOT NULL, lexicon VARCHAR(6000), display_name VARCHAR(255), guild_id BIGINT);"]
