...
def create_tables() -> list:
    ...
    "CREATE TABLE identities(identity_id INT NOT NULL AUTO_INCREMENT PRIMARY KEY, name VARCHAR(255) NOT NULL, user_id BIGINT NOT NULL, avatar VARCHAR(255), lexicon VARCHAR(6000), allowed_words VARCHAR(3000), display_name VARCHAR(255), guild_id BIGINT, colour VARCHAR(7));",
    "CREATE TABLE users(discord_id BIGINT NOT NULL PRIMARY KEY, drone_id VARCHAR(4));"]
