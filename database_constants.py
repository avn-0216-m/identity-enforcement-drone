...
def create_tables() -> list:
    ...
    "CREATE TABLE identities(identity_id INT NOT NULL AUTO_INCREMENT PRIMARY KEY, name VARCHAR(255) NOT NULL, user_id BIGINT NOT NULL, lexicon_id INT, display_name VARCHAR(255), guild_id BIGINT);",
